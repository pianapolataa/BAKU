    ...
    def run(self, duration_s: float = 60.0, freq: float = 50.0):
        ...
        try:
            ...
            while time.time() - t0 < duration_s:
                ...
                if (cnt < 17): action = action_1.copy()
                print(cnt)
...
def main(cfg: DictConfig):
    ...
    snapshot_path = "/home_shared/grail_sissi/BAKU/baku/exp_local/2025.11.24_train/deterministic/151723/snapshot/51000.pt" # new 11 demo w noise
