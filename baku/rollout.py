    ...
    def run(self, duration_s: float = 60.0, freq: float = 50.0):
        ...
        try:
            for cnt in range(num_steps):
                ...
                hand_action[14] = (hand_action - 1990) / 2 + 1990
...
def main(cfg: DictConfig):
    ...
    snapshot_path = "/home_shared/grail_sissi/BAKU/baku/exp_local/2026.01.23_train/deterministic/112147/snapshot/37000.pt" # marker picking
